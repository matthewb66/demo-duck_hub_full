...
##############################################################################
##
##  scan.GUI start up script for UN*X
##
##############################################################################
...
CLASSPATH=$APP_HOME/lib/scan.cli-2021.6.0-standalone.jar

export LANG=en_US.utf8
SCAN_CLI_OPTS="-Done-jar.main.class=com.blackducksoftware.scan.cli.impl.ScanClient2 -Done-jar.silent=true -Done-jar.jar.path='$APP_HOME'/lib/cache/scan.cli.impl-standalone.jar $SCAN_CLI_OPTS"
